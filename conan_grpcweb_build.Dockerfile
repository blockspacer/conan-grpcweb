...
FROM conan_grpcweb_repoadd_source_install as conan_grpcweb_build_package_export_test_upload

ARG BUILD_TYPE=Release
ARG APT="apt-get -qq --no-install-recommends"
ARG LS_VERBOSE="ls -artl"
ARG CONAN="conan"
ARG PKG_NAME="conan_grpcweb/v1.26.x"
ARG PKG_CHANNEL="conan/stable"
ARG PKG_UPLOAD_NAME="conan_grpcweb/v1.26.x@conan/stable"
